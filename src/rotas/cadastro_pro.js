...
router.post('/', async (req, res) => {
  try {
    ...
    const profissional = {nomePro: nomePro, emailPro: emailPro, telefonePro: telefonePro, sobreNomePro: sobreNomePro, nascimentoPro: nascimentoPro, cpfPro: cpfPro, senhaPro: senhaCriptografadaPro};
